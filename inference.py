...
def run_dense_retrieval(
    ...
    datasets_for_train = load_from_disk("../data/train_dataset")
    retriever = DenseRetrieval(
        training_args, datasets_for_train, num_neg=2, tokenizer=tokenize_fn, 
        data_path=data_path, context_path=context_path
    )
    retriever.get_dense_embedding(model_args)
...
def run_mrc(
    ...
    def post_processing_function(
        ...
        predictions = postprocess_qa_predictions(
            ...
            prefix=model_args.predict_file_name,
        )
