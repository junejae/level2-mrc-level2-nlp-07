...
class ElasticSearch:
    ...
    def __init__(self):
        ...
        self.wiki_path: str = "/opt/ml/input/data/wikipedia_documents.json"
    ...
    def set_elastic_server(self):
        path_to_elastic = "/opt/ml/input/code/retrieval/elasticsearch-7.9.2/bin/elasticsearch"
        es_server = Popen(
            [path_to_elastic],
            stdout=PIPE,
            stderr=STDOUT,
